...
DATABASES = {
    'default': {
        ...
        'NAME': CURRENT_PATH + '/sqlite.db', # Or path to database file if using sqlite3.
...
SECRET_KEY = 'd%$av_&*pb+dsaw2ix2(^-w@%f80g_*=p5j04!*y_t+9$)4u)i'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    "utils.context_processors.add_settings")
